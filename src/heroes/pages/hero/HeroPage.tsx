...
// comp que obtiene el hero por su idSlug y lo renderiza
export const HeroPage = () => {
  ...
  // Retorna un objeto con la data obtenida y renombrada a superheroData y la prop isError
  const {data: superheroData, isError} =  useQuery({
    ...
    //llama a la func. que hace petición http, enviando argumento idSlug.
    ...
    //no reintentar la petición http si falla el primer intento.
    retry: false,
  });
