...
describe('getHerosByPageAction', () => {
    ...
    test('debe retornar los heroes', async () => {
    ...
    test('debe retornar pag de heroes correcta, si la pagina en url no es numero', async () => {
        const responseOject = {
            total: 10,
            pages: 1,
            heroes: []
        }
        heroesApiMock.onGet('/').reply(200, responseOject);
    ...
    test('debe retornar pag de heroes correcta, si la pagina en url es un string', async () => {
        const responseOject = {
            total: 10,
            pages: 1,
            heroes: []
